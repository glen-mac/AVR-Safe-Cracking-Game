;this is the code that handles the ADC interrupts. The ADC is on free running
;mode which means it will run a new ADC interrupt whenver the last ADC conversion is
;complete
handleADC:
	push temp
	in temp, SREG
